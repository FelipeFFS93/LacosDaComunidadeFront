...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">lacos-da-comunidade documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-d1dd9f1a3a69844fac8accf2809d6ef8"' : 'data-target="#xs-components-links-module-AppModule-d1dd9f1a3a69844fac8accf2809d6ef8"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-d1dd9f1a3a69844fac8accf2809d6ef8"' :
                                            'id="xs-components-links-module-AppModule-d1dd9f1a3a69844fac8accf2809d6ef8"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CadastrarEventoComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >CadastrarEventoComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/TecnologiaComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >TecnologiaComponent</a>
                                            </li>
                                            <li class="link">
